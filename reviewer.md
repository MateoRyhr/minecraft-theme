...
3. For each modified/created file:
   ...
   - Does it have no `console.log`, no orphaned TODOs without context?
4. Verify manually:
...
- C1: [x]
- C2: [x]
- C3: [ ]  ← Reason: Missing editor.selectionBackground color key
- C4: [x]
- C5: [x]

## Changes Required (if any)
1. Add missing editor.selectionBackground color key in ...
2. Remove console.log in extension.js:42
3. ...
```
